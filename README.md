...
| grouped-bar-chart | `[{ key: "", value: { v1: n, v2: n, ...} }, ...]` | <ul><li>`tooltip`</li><li>`standout`: any _key_ group that should be charted separate from others</li><li>`maxgroups`: number of _key_ groups to show per single chart. multiple charts created if more _key_s exist</li></ul> | Bar chart grouped by specified _key_s |
| stacked-bar-chart | `[{ key: "", value: { v1: n, v2: n, ...} }, ...]` |  | Bar chart stacked by specified _key_s |
