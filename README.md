...
Simple Data Vis is a JavaScript module to more easily visualize data, such as those gathered by the [Simple Metrics Collector](https://developer.ibm.com/clouddataservices/2016/03/03/simple-metrics-collector-microservices-edition/).
