...
SimpleDataVis.tooltip = function() {
  ...
  tooltip.mouseover = function(d, i, options, text) {
    tooltipselection
      .text(tooltip.text(d, i, options, text))
      .style('visibility', 'visible');
  };

  tooltip.mousemove = function(d, i) {
    tooltipselection
      .style('top', (d3.event.pageY-10)+'px')
      .style('left',(d3.event.pageX+10)+'px');
  };

  tooltip.mouseout = function(d, i) {
    tooltipselection.style('visibility', 'hidden');
  };

  tooltip.text = function(d, i, options, text) {
    return function() {
